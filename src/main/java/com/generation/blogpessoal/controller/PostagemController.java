...
@CrossOrigin(origins = {"http://localhost:5173", "https://blogpessoal.vercel.app"}, allowedHeaders = "*")
public class PostagemController {
	...
	public ResponseEntity<Postagem> getById(@PathVariable Long id){
		return postagemRepository.findById(id).map(resposta -> ResponseEntity.ok(resposta)).orElse
